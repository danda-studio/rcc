...
export const ComplexConstructionWidget = () => {
  ...
  const slides = [
    ...
    {
      image: "/images/complex/carousel/Q6.webp",
      year: "I-кв 2026",
      title: "Монтаж инженерных систем",
      description: "Устройство системы жизнеобеспечение дома водоснабжение системы, канализация, пожаротушение, отопление, электроснабжение и.т.д",
    },
  ];
