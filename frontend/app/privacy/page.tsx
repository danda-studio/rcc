export default function PrivacyPage() {
  return (
    <div className={`
      text-blue-6
      [&_a]:whitespace-nowrap [&_a]:text-gold-3 [&_a]:underline
    `}
    >
      <h1 className={`
      ...
      <br />
      <br />
      Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые ООО "СЗ" РСК"" ИНН 9309026106, ОГРН 1239300010861 (далее — Оператор).
      <br />
      <br />
      1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.
      <br />
      <br />
      1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайтов
      {" "}
      <a href="https://rskdnr.ru/" data-text-link="">https://rskdnr.ru</a>
      ,
      {" "}
      <a href="http://rsk-olimpiyskiy.ru/" data-text-link="">http://rsk-olimpiyskiy.ru</a>
      ,
      {" "}
      <a href="http://rsk-zhukova.ru/" data-text-link="">http://rsk-zhukova.ru</a>
      .
      <br />
      <br />
      ...
      ,
      {" "}
      <a href="http://rsk-olimpiyskiy.ru">http://rsk-olimpiyskiy.ru</a>
      ,
      {" "}
      <a href="http://rsk-zhukova.ru">http://rsk-zhukova.ru</a>
      .
      <br />
      <br />
      ...
      <a href="https://rskdnr.ru">https://rskdnr.ru</a>
      ,
      {" "}
      <a href="http://rsk-olimpiyskiy.ru">http://rsk-olimpiyskiy.ru</a>
      ,
      ...
      {" "}
      <a href="mailto:mail@rskdnr.ru" data-text-link="">mail@rskdnr.ru</a>
      {" "}
      ...
      {" "}
      <a href="https://rsk-olimpiyskiy.ru/privacy">https://rsk-olimpiyskiy.ru/privacy</a>
      .
    </div>
  );
}
